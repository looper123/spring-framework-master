...
<body>
      <form role="form"  id="addForm" action="${pageContext.request.contextPath}/tree/addNode.action" >
        <div class="form-group form__div_style"  style="width: 550px">
          ...
          <input type="text" class="form-control" style="height: 40px" id="name" name="name" placeholder="请填写内容" />
        </div>
        <div class="form-group form__div_style"  style="width: 550px">
        <label for="id">节点ID</label>
        <input type="text" class="form-control" style="height: 40px" id="id" name="id" placeholder="请填写内容" >
        </div>
        <div class="form-group form__div_style"  style="width: 550px" >
          <label for="pId">父节点id</label>
          <input type="hidden"  style="height: 40px" id="pId" name="pId" placeholder=" "/>
        </div>
...
//            给隐藏的父节点赋值
              parentID =String(${requestScope.pId});
            $("#pId").val(parentID);
          });
