...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/jquery/jquery.serializejson.min.js"></script>
    <%--bootstrap校验--%>
    ...
    <script src="${pageContext.request.contextPath}/resources/bootStrap/js/bootbox.min.js"></script>
    <%--<!--[if lte IE 8]>--%>
                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <%--<form action="${pageContext.request.contextPath}/user/checkUserLogin.action" accept-charset="utf-8" method="post">--%>
                                    <form id="loginForm">
                                        <fieldset>
                                ...
                                <div class="toolbar clearfix">
                                    ...
                                    <div>
                                        ...
                                        <a href="${pageContext.request.contextPath}/user/skipToRegister.action"
...
////                            },
//                    regexp: {
//                        regexp: /^[[A-Za-z0-9]{6,11}/,
//                        message: '用户密码必须为6位到11位的数字或者大小写字母组合'
//                    }
//                }
//            }
//        });
...
//        };
        alert(JSON.stringify(loginForm.serializeJSON()));
        alert(typeof (JSON.stringify(loginForm.serializeJSON())));
        $.ajax({
            type: "post", // 提交方式 get/post
            url: "${pageContext.request.contextPath}/user/checkUserLogin.action", // 需要提交的 url
            data: JSON.stringify(loginForm.serializeJSON()), //使用jquery的插件来获取json字符串
//    接收服务器的数据的类型
            dataType: 'json',
//    客户端传递给服务器端的数据类型
