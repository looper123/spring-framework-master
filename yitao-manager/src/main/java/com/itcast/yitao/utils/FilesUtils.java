...
public class FilesUtils {
    ...
    /**
     * use spring mvc files Upload method   transferTo()
     * MultipartFile use TransferTo method upload
     *
     * @param request       HttpServletRequest
     * @param multipartFile MultipartFile(spring)* @param filePath      filePath example "/files/Upload"
     * @return
     */
    public static String FilesUpload_transferTo( MultipartFile multipartFile, String filePath) {
        String suffix = null;
...
//            String relativePath = getRelativePath(filePath, suffix);
        ...
        try {
            File file = new File("d:\\upload." + suffix);
            //save file
